  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        width={"50%"}
      >
        <Text fontSize={"35pt"}>Terms & Conditions</Text>
        <br />
        <Text>
          ...
          problems. By using PicAnswer, you agree to be bound by these terms and
          conditions. <br />
          <br />
          ...
          property rights that you hold in your content, but you grant PicAnswer
          a non-exclusive, royalty-free, transferable, sub-licensable, worldwide
          license to use, copy, modify, and distribute your content in
          connection with the PicAnswer services.
          <br />
          <br />
          3.&nbsp;&nbsp;Limitation of Liability: PicAnswer is not responsible
          for any damages or losses resulting from the use of the app, including
          without limitation, indirect, incidental, special, punitive, or
          consequential damages. <br />
          <br />
          4.&nbsp;&nbsp;Disclaimer of Warranties: PicAnswer provides the app on
          an "as is" and "as available" basis. PicAnswer makes no
          ...
          expenses arising from your use of the app or from your breach of these
          terms and conditions. <br />
          <br />
          6.&nbsp;&nbsp;Changes to Terms: PicAnswer reserves the right to modify
